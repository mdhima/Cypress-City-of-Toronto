...
<body>
    <section class="fullCard" id="thumbnail">
        ...
        <div class="cardContent">
            ...
            <div id="main suggestScreen" style="text-align: -webkit-center;">
                <p style="font-size:20px">All Reports</p>
                <div>
                <?php
                        ...
                        if (mysqli_num_rows($reports) > 0) {
                            echo "<table>";
                            echo "<tr>";
                            echo "<td class=\"underline\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">Date</t>";
                            echo "<td class=\"underline\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">Address</t>";
                            echo "<td class=\"underline\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">Issue</t>";
                            echo "<td class=\"underline\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">Resolution</t>";
                            echo "<td class=\"underline\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">Actions</t>";
                            echo "</tr>";
                            while ($fetch = mysqli_fetch_assoc($reports)) {
                                ...
                                echo "<td class=\"italic\" style=\"text-align:center; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">$resolved</t>";
                                echo "<td style=\"text-align:center; width: auto; padding: 2px 10px; border: 2px solid rgb(11, 117, 255);\">";
                                if ($solved == 0) {
                                    echo "<button onclick=\"suggestionBox()\" style=\"margin: 2px 5px\" class=\"btn btn-primary\">Make a Suggestion</button></t>";
                                } else {
                                    echo "No suggestions required</t>";
                                }
                                echo "</tr>";
                                echo "</form>";
                            }
