        ...
        <div class="cardContent">
            ...
            <div id="outline">
              <div class="profileScreen cardText">
                  ...
                  <p>Prénom: <?php echo htmlspecialchars($_SESSION["fname"]); ?></p>
                  ...
                  <p>Numéro de téléphone: <?php echo htmlspecialchars($_SESSION["phone"]); ?></p>
                  <br>
                  <button type="button" class="btn btn-primary ">
                      <a href="profileedit.php" style="color:white;text-decoration:none">Éditer vos informations</a>
                  </button>
