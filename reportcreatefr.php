    ...
    if(empty($address_err) && empty($problem_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                $result = "Rapport créé avec succès!";
            } else {
...
<html lang="fr">
    <head>
        ...
        <title>Cypress Créer Un Rapport</title>
    </head>
<body>
    <section class="fullCard" id="thumbnail">
        ...
        <div class="cardContent">
            ...
            <div class="reportCreate cardText">
                <h5 id="titleFomat4">Créer un rapport</h5>
                <br>
                <span style="font-size: 20px"><?php echo $result ?></span>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="reportCreateScreen">
                        <div>
                            ...
                            <br>
                            <span style="font-size:10px"><?php echo $address_err; ?></span>
                            <br>
                        </div>
                        ...
                        <br>
                        <span style="font-size:20px"><?php echo $problem_err; ?></span>
                        <br>
                        <div class="buttons">
                          <p></p>
