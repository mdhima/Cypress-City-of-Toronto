...
<body>
    <section class="fullCard" id="thumbnail">
        ...
        <div class="cardContent">
            ...
            <div id="main">
                <p style="font-size:20px">Mes rapports</p>
                <?php
                        ...
                        if (mysqli_num_rows($reports) > 0) {
                            ...
                            while ($fetch = mysqli_fetch_assoc($reports)) {
                                ...
                                if ($solved == 0) {
                                    ...
                                    $resolved = "Résolu. Merci d'avoir signalé.";
                                }
                                echo "<tr>";
                                ...
                                echo "<form action=\"editReportfr.php\" method=\"get\">";
                                    echo "<input type=\"hidden\" name=\"id\" value=$id>";
                                    echo "<button type=submit style=\"margin: 2px 5px\" class=\"btn btn-primary\">Éditer</button>";
                                echo "</form>";
                                echo "<form action=\"deleteReportfr.php\" method=\"get\">";
                                    echo "<input type=\"hidden\" name=\"id\" value=$id>";
                                    echo "<button style=\"margin: 2px 5px\" class=\"btn btn-primary\">Effacer</button></td>";
                                echo "</tr>";
                                echo "</form>";
                            }
                            echo "</table>";
